//scroll
let elem = document.getElementById('percentual')
...
jQuery(document).ready(function( $ ) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
      ...
      $('#header').addClass('nav-menu-scrolled');
      $('#header').addClass('mobile-nav-toggle-scrolled');
    } else {
      $('#header').removeClass('header-scrolled');
      $('#header').removeClass('nav-menu-scrolled');
      $('#header').removeClass('mobile-nav-toggle-scrolled');
    }
  });
